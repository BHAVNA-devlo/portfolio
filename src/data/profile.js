export const profile = {
  ...
  availability: 'Open to frontend roles, freelance builds, and product collaborations.',

};

export const contactLinks = [
  { label: 'Email',  href: 'bhavnasingh2196@gmail.com' },
  { label: 'GitHub', href: 'https://github.com/BHAVNA-devlo/' },
  { label: 'LinkedIn', href: 'https://www.linkedin.com/in/bhavna-singh-45079a2a2/' },
